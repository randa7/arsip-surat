...
<body>
	...
	<tr>
		...
		<tr>
			<td colspan="4" align="justify" class="nomor2"><p style="text-align: justify-all; padding-left: 55px">Hal &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: <b>Daftar Nama Siswa PKL TP.{{$request["ajaran"]}} </b> </p></td>
		</tr>
		...
		<tr>
			<td colspan="12" class="nomor2" align="justify" style="padding-left: 140px; padding-right: 70px;">Dengan hormat. Sehubungan dengan pelaksanaan Praktik Kerja Lapangan TP.{{$request["ajaran"]}}, dengan ini kami beritahukan nama siswa peserta Praktik Kerja Lapangan sebagai berikut :
...
<div>
<p style="margin-left:140px; padding-right:70px;" class="nomor2" align="justify">Demikianlah surat ini kami sampaikan, atas perhatian dan kesediaan Bapak/Ibu kami ucapkan terima kasih.</p>
<div>
<div style ="">  
