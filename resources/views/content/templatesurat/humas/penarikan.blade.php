...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
  <h1 class="h3 mb-0 text-gray-800">Buat Surat Penarikan PKL</h1>
  <ol class="breadcrumb">
      <li class="breadcrumb-item"><a href="/">Home</a></li>
      <li class="breadcrumb-item" aria-current="page"><a href="/humas">Template Surat Humas </a></li>
      <li class="breadcrumb-item active" aria-current="page">Surat Penarikan PKL</li>
  </ol>
  </div>
...
<div class="card mb-4">
  <div class="container col-md-12">
    <br>
    <h3 class="card-title text-center">Surat Penarikan PKL</h3>
            <!-- membuat form  -->
            <!-- gunakan tanda [] untuk menampung array  -->
            <form enctype="multipart/form-data" role="form" action="/humas/suratpenarikan" method="POST" target="_blank">
              @csrf
